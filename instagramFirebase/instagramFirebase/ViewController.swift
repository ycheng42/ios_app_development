...
//  instagramFirebase
//
//  Created by Terry Cheng on 12/26/17.
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        } else if let oringinalImage = info["UIImagePickerControllerOriginalImage"]as? UIImage {
            plusPhotoButton.setImage(oringinalImage.withRenderingMode(.alwaysOriginal), for: .normal)
        }
